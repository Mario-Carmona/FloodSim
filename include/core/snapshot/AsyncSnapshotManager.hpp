...
namespace danasim {
    ...
    public:
        ...
        std::pair<Snapshot, std::unique_ptr<SnapshotReadGuard>> waitForSnapshot(uint64_t lastStep) override;

        void stop() override;
        bool isRunning() const noexcept override { return running_; }
        std::size_t everyNSteps() const noexcept override { return everyNSteps_; }
