 ...
 */
void RenderMainControlTab(app::config::Config& config, std::atomic<bool>& is_simulation_running, 
                          std::shared_ptr<app::Application>& current_simulation, std::jthread& simulation_thread);
